...
let handler = async (m, { conn, args, usedPrefix, command, text }) => {
    ...
    try {
        ...
        let context = `Eres The Rage (v3.0). Idioma: ${idioma.toUpperCase()}\n` +
                     `Creador: Bruno Sobrino | Repositorio: https://github.com/Santx07/rage | Numero del creador: +52 1 999 612 5657\n\n`;
